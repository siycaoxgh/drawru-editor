...
## v3.7.5 — Electron 桌面版与发布信息完善

### Electron
- 增加 Electron 桌面运行入口和 Windows NSIS 安装包配置
- 设置窗口图标、安装包图标和应用名称 `DrawRu 编辑器`
- 移除 Electron 默认英文菜单，关于信息统一由编辑器页面提供

### 软件信息
- 编辑器顶部增加“ℹ️ 关于”按钮
- 开发者信息统一为 `XAOCEN STUDIO`
- 版权信息统一为 `© 2026 XAOCEN`

### COS 与发布安全
- 增加可双击运行的 `switch-cos-assets.bat`
- 支持 COS 地址一键切换与占位地址一键还原
- 公开仓库不保存真实 COS 域名
